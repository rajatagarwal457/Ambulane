...
//Initialize Google Play Services
    ...
    public void onLocationChanged(Location location) {
        ...
        if (null != locations && null != providerList && providerList.size() >= 0) {
            ...
            try {
                ...
                // Here we are finding , whatever we want our marker to show whenclicked
                    ...
                    final String AppID = Settings.Secure.getString(getContentResolver(),
                            Settings.Secure.ANDROID_ID);
                    Log.d("AppID", AppID);


                    final Button startButton = (Button) findViewById(R.id.ToggleService);
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        startButton.setElevation(2);
                    }
                    ...
                    startButton.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            TextView btn = v.findViewById(R.id.ToggleService);

                            check = !check;
                            if(check) {
                                btn.setText("STOP");
                                btn.setBackgroundColor(Color.parseColor("#ee0000"));
                                btn.setTextColor(Color.WHITE);
                                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                                    startButton.setElevation(8);
                                }

                                Log.d("inside", "click started");
                            } else {
                                btn.setText("START");
                    ...
                    if (check){
                        if (!AppID.equals("")) {
                            new AddLocation().execute(AppID, slatitude, slongitude, sangle);
                        } else {
                            Log.e("inside", "AppID not found. Cannot send data");
                        }
                    }
                }
            } catch (IOException e) {
        ...
        markerOptions.icon(BitmapDescriptorFactory.fromResource(R.drawable.ic_blue_ambulance_icon));
...
// Do the contacts-related task you need to do.
    ...
    private String URL_LOCATION = "https://ambulanedb.000webhostapp.com/htdocs/Driver/add_driver_location.php";
    ...
    private class AddLocation extends AsyncTask<String, Void, Void> {
        ...
        protected Void doInBackground(String...arg) {
            ...
            String mAppID = arg[0];
            String mLatitude = arg[1];
            String mLongitude = arg[2];
            String mBearing = arg[3];

            // Preparing post params
            List<NameValuePair> params = new ArrayList<NameValuePair>();
            params.add(new BasicNameValuePair("mAppID", mAppID));
